...
(function (_r) {
    ...
    _r.isFunction = isFunction;
    function isNumber(n) {
        return !isNaN(parseFloat(n)) && isFinite(n);
    }
    _r.isNumber = isNumber;
    function isObject(n) {
        return n !== null && typeof n === 'object';
    }
    _r.isObject = isObject;
    function isArray(x) {
    ...
    _r.isVector3 = isVector3;
    function isVector2(x) {
        return x instanceof BABYLON.Vector2;
    }
    _r.isVector2 = isVector2;
    function isColor(x) {
        return isHexColor(x) || x instanceof BABYLON.Color3 || x instanceof BABYLON.Color4;
    }
    _r.isColor = isColor;
    function isHexColor(x) {
        return isString(x) && x[0] == '#';
    }
    _r.isHexColor = isHexColor;
    function isFloat(n) {
    ...
    function animate(nodes, properties, options) {
        ...
        elements.each(function (element) {
            ...
            Object.getOwnPropertyNames(properties).forEach(function (property) {
                ...
                if (_r.isObject(properties[property])) {
...
(function (_r) {
    _r.overrides = [];
    _r.helpers = [];
    // TODO : testExecutionTime(function() {})
    ...
    function merge(target, source, excluded) {
        for (var property in source) {
            ...
            var override = _r.overrides[property];
            if (override) {
                override(target, source, property);
            }
            else {
                if (_r.isFunction(source[property])) {
                    target[property] = source[property].call();
                }
                else {
                    if (typeof source[property] == 'object') {
                        ...
                        if (Object.getOwnPropertyNames(source[property]).length == 1) {
                            var prop = Object.getOwnPropertyNames(source[property])[0];
                            var helper = _r.helpers[prop];
                            if (helper) {
                                target[property] = helper.call(target, source[property][prop]);
                                continue;
                            }
                        }
                        if (!target[property]) {
                        ...
                        target[property] = this.merge(target[property], source[property]);
                    }
                    else {
                        if ((target[property] instanceof BABYLON.Color3 || target[property] instanceof BABYLON.Color4) && typeof source[property] === "string") {
                            target[property] = BABYLON.Color3.FromHexString(source[property]);
                        }
                        else {
    ...
    _r.merge = merge;
    // TODO : extend(...objects : any[]);
    // var options = _r.extends({}, options, defaultOptions);
    ...
    function runRenderLoop() {
        _r.engine.runRenderLoop(renderLoop);
    }
    _r.runRenderLoop = runRenderLoop;
    function stopRenderLoop() {
        _r.engine.stopRenderLoop(renderLoop);
    }
    _r.stopRenderLoop = stopRenderLoop;
    function init(scene) {
        if (scene) {
            _r.scene = scene;
            _r.engine = scene.getEngine();
            _r.canvas = _r.engine.getRenderingCanvas();
            _r.plugins.forEach(function (plugin) {
                plugin.initialize({
                    scene: _r.scene.name,
                    container: _r.canvas
                });
...
(function (_r) {
    ...
    function data(elements, key, value) {
        ...
        el.each(function (_element) {
            if (!_element.hasOwnProperty(_r.expando)) {
                _element[_r.expando] = _r._cache.length;
                _r._cache[_element[_r.expando]] = [];
            }
            if (key) {
                if (value) {
                    _r._cache[_element[_r.expando]][key] = value;
                }
                else {
                    if (!_r._cache[_element[_r.expando]][key]) {
                        _r._cache[_element[_r.expando]][key] = {};
                    }
                    result = _r._cache[_element[_r.expando]][key];
                    return false; // break the each.
                }
            }
            else {
                result = _r._cache[_element[_r.expando]];
                return false; // break the each.
            }
        });
        if (result) {
...
(function (_r) {
    ...
    function on(elements, event, handler, repeat) {
        ...
        el.each(function (element) {
            ...
            if (_r.isMesh(element) && _meshTriggers.indexOf(event) != -1) {
...
(function (_r) {
        ...
        BABYLON.SceneLoader.ImportMesh(null, params.rootUrl, params.fileName, _r.scene, function (meshes) {
            ...
            if (params.patch) {
                ...
                params.patch.forEach(function (_patch) {
                    promises.push(_r.loadPatch(_patch));
                });
                Q.all(promises).then(function (data) {
                    try {
                        data.forEach(function (_patch) {
                            _r.applyPatch(_patch);
                        });
            ...
            deferred.notify({
                loaded: ev.loaded,
                total: ev.total,
                percent: ((ev.loaded / ev.total) * 100).toFixed()
            });
        }, function () {
    ...
    _r.importLibrary = importLibrary;
    function hideLibrary(libraryName) {
        if (_r.libraries[libraryName]) {
            _r.libraries[libraryName].forEach(function (meshName) {
                _r.scene.getMeshByName(meshName).dispose(true);
            });
        }
    }
    _r.hideLibrary = hideLibrary;
})(_r || (_r = {}));
var _r;
(function (_r) {
    _r.plugins = new Array();
    function registerPlugin(plugin) {
        _r.plugins.push(plugin);
    }
    _r.registerPlugin = registerPlugin;
    _r.isReady = false;
    ...
    function load(scene, assets, progressLoading) {
        var deferred = Q.defer();
        if (_r.isFunction(scene)) {
            _r.scene = scene.call(this, _r.engine, _r.canvas);
    ...
    function launch(params) {
        ...
        if (params.hasOwnProperty('container')) {
            if (_r.isString(params['container'])) {
        ...
        load(params.scene, params.assets, params.progressLoading || null).then(function () {
            _r.plugins.forEach(function (plugin) {
...
(function (_r) {
    ...
    _r.getPatch = getPatch;
    function applyPatch(_patch) {
    ...
    _r.applyPatch = applyPatch;
    function loadPatch(patch) {
        var deferred = Q.defer();
        if (isPatchFile(patch)) {
            getPatch(patch).then(function (data) {
                deferred.resolve(data);
            }, function (err) {
    ...
    _r.loadPatch = loadPatch;
    function patch(nodes, patch) {
        ...
        Elements.prototype.concat = function () {
            ...
            elements.forEach(function (element) {
                ...
                if (element instanceof Elements) {
                    ...
                    if (_r.isString(element)) {
                        base = new Elements(element);
                    }
                    else {
                        if (_r.isArray(element)) {
                            base = new Elements();
...
(function (BABYLON) {
    ...
    BABYLON.PanCameraPointersInput = PanCameraPointersInput;
    BABYLON.CameraInputTypes["ArcRotateCameraPointersInput"] = BABYLON.ArcRotateCameraPointersInput;
})(BABYLON || (BABYLON = {}));
var _r;
(function (_r) {
    function convertToPanCamera(camera) {
        camera.inputs.remove(camera.inputs.attached['pointers']);
        var panInputs = new BABYLON.PanCameraPointersInput();
        camera.inputs.add(panInputs);
    }
    _r.convertToPanCamera = convertToPanCamera;
})(_r || (_r = {}));
var _r;
(function (_r) {
    var excluded = ["rootUrl", "extensions", "noMipmap", "files", "onLoad", "coordinatesMode"];
    function cubeTexture(params) {
        ...
        if (params.coordinatesMode) {
            if (_r.isNumber(params.coordinatesMode)) {
        ...
        return _r.merge(texture, params, excluded);
    }
    _r.cubeTexture = cubeTexture;
    _r.helper("cubeTexture", function (params) {
        return _r.cubeTexture(params);
    });
})(_r || (_r = {}));
var _r;
(function (_r) {
...
var _r;
(function (_r) {
    function reflectionProbe(params) {
        ...
        if (params.refreshRate) {
            if (_r.isNumber(params.refreshRate)) {
    ...
    _r.reflectionProbe = reflectionProbe;
    _r.helper("reflectionProbe", function (params) {
        return _r.reflectionProbe(params);
    });
})(_r || (_r = {}));
var _r;
(function (_r) {
    ...
    _r.setActiveCamera = setActiveCamera;
...
var _r;
(function (_r) {
    var excluded = ["url", "noMipmap", "invertY", "coordinatesMode", "samplingMode", "onLoad", "onError", "buffer"];
    function texture(params) {
        if (params.samplingMode) {
            if (_r.isNumber(params.samplingMode)) {
    ...
    _r.texture = texture;
    _r.helper("texture", function (params) {
        return _r.texture(params);
    });
})(_r || (_r = {}));
var _r;
(function (_r) {
    var excluded = ["name", "urls", "generateMipMaps", "invertY", "samplingMode"];
    // TODO _r.videoTexture(material, params)
    ...
    _r.videoTexture = videoTexture;
    _r.helper("videoTexture", function (params) {
        return videoTexture(params);
    });
})(_r || (_r = {}));
var _r;
(function (_r) {
...
(function (_r) {
    _r.override(["includedOnlyMeshes", "excludedMeshes"], function (target, source, property) {
        if (_r.isArray(source[property])) {
            target[property] = _r.select(source[property].join(',')).toArray();
        }
        else {
            if (_r.isString(source[property])) {
